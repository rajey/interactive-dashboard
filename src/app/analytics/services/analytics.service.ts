...
import { generateDummyAnalytics } from '../helpers/generate-dummy-anaytics.helper';
import { getAnalyticsUrl } from '../helpers/get-analytics-url.helper';
import { getAnalyticsWithGrouping } from '../helpers/get-analytics-with-grouping.helper';
import { getDataSelectionsForMetadata } from '../helpers/get-data-selection-for-metadata.helper';
import { getMergedAnalytics } from '../helpers/get-merged-analytics.helper';
...
export class AnalyticsService {
  ...
  private _getFunctionAnalytics(dataSelections: any[]) {
  ...
  private _getDataSelectionByDxType(
    ...
    const dxDataSelection: any = _.find(dataSelections, ['dimension', 'dx']);
